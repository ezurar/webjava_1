...
public class UserListController {
  ...
  public ModelAndView index(ModelAndView mav) {
    ...
    mav.addObject("userForm", new ListForm());  // 新規クラスを設定
  ...
  private ModelAndView adduser(ModelAndView mav, @Valid ListForm userForm, BindingResult bindingResult, HttpServletRequest request) {
